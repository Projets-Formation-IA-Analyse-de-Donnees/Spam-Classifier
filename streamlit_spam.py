...
####
# ouvertur des fichiers
####

# ouverture du fichier model_parametre.json
df_json = pd.read_json("C:\Users\naouf\Documents\Naoufel\projet\SpamClassifier\regrouppement\Module_spam_v3.py", encoding = "utf-8", dtype=False)
print("df = ", df_json)
...
# bouton pour validé la recherche
...
if st.session_state.clicked :
    ...
    try :
        ...
        if st.session_state.stage >= 3:
            ...
            st.write("le modèle n'est pas valédé")
...
if st.session_state.selected :
    ...
    st.write(model)
    st.write('ses meilleurs paramettres sont = ')
