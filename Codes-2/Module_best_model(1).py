...
class model_best :
    ...
    def __init__(self):
        #ouvertur des fichier
        self.df_json = pd.read_json("C:/Users/naouf/Documents/Naoufel/projet/SpamClassifier/regrouppement/model_parametre.json", encoding = "utf-8")
        self.path_csv = "C:/Users/naouf/Documents/Naoufel/projet/SpamClassifier/regrouppement/best_model_-_Copie.csv"
    ...
    def grid_serch_best_model (self) :
        ...
        for count in range(0,len(self.liste_model)) :
            ...
            # test : lance la recherche des parametre idéals
            # si succès : l'ajoute à df_best_model l'enregistre dans le fichier best_model
