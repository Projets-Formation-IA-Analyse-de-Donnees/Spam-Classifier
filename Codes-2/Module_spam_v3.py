...
class model_IA :
    ...
    # Constructeur, avec en argumant le point d'apparition de la tuile
    ...
    def telephone_posible (self, sms) :
        ...
        sortie : boolean
        ---------------------
        crée le pattern des numeros de tel
    ...
    def train_et_test (self, df) :
        """
        entrée : un data frame, pourcentage de valeurs à mettre dans df_test
